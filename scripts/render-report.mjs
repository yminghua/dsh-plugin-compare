...
import { renderComparisonHtml, renderComparisonSvg, serializeComparisonReport, sanitizeComparisonReport } from '../lib/core/index.js'
import { ComparisonView } from '../src/client/index.ts'
import { comparisonStyles } from '../src/client/styles.ts'
